...
CREATE TABLE `admin_tokens` (
    ...
    PRIMARY KEY (`token`),
    KEY `adminID` (`adminID`),
    CONSTRAINT `admin_tokens_ibfk_1` FOREIGN KEY (`adminID`) REFERENCES `admins` (`adminID`) ON DELETE CASCADE
...
VALUES (
        1,
        'jp',
        '$2y$12$raub0ObBjBAoXZksCyQ4oONlKpeqD5h9gE95NIpKA6y4gen3oLlUS'
    ),
    (
        2,
        'pumaman',
        '$2y$12$Ft4NDK0hsf4DvwH4wWbQrObsGtqfston1h9tinX/vXQNVMjpxqfpK'
    );
...
CREATE TABLE `cities` (
    ...
    `AsciiName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `CountryCodeISO` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `continents` (
    `ContinentCode` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
    `ContinentName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `countries` (
    ...
    `ISONumeric` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `CountryName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    ...
    `Population` int DEFAULT NULL,
    `Continent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `TopLevelDomain` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `CurrencyCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `CurrencyName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `PhoneCountryCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `Languages` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `Neighbours` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `CountryDescription` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    PRIMARY KEY (`ISO`),
...
VALUES (
    ...
    (
        ...
        'es-CO',
        'EC,PE,PA,BR,VE',
        'Colombia, officially the Republic of Colombia, is a country largely situated in the north of South America, with land, and territories in North America. Colombia is bounded on the north by the Caribbean Sea and the west by the Pacific. It comprises thirty-two departments, with the capital in Bogota.'
    ),
    (
        'CR',
        '188',
    ...
    (
        ...
        'Serbia and Montenegro, also known from 2003 to 2006 as the State Union of Serbia and Montenegro, and known as the Federal Republic of Yugoslavia from 1992 to 2003, was a country in Southeast Europe, created from the two remaining federal republics of Yugoslavia after its breakup in 1992. The republics of Serbia and Montenegro together established a federation in 1992 as the Federal Republic of Yugoslavia for short.'
    ),
    (
        'CU',
        '192',
    ...
    (
        ...
        'en-GH,ak,ee,tw',
        'CI,TG,BF',
        'Ghana is a country in West Africa. It is bordered by Cote d\'Ivoire (Ivory Coast) to the west, Burkina Faso to the north, Togo to the east, and the Gulf of Guinea to the south. The word Ghana means \"Warrior King\" and is derived from the ancient Ghana Empire.'
    ),
    (
        'GI',
        '292',
    ...
    (
        ...
        'el-GR,en,fr',
        'AL,MK,TR,BG',
        'Greece, officially the Hellenic Republic, is a country located in Southeast Europe. Its population is approximately 10.7 million as of 2018; Athens is the nation\'s capital and largest city, followed by Thessaloniki.'
    ),
    (
        'GS',
        '239',
    ...
    (
        ...
        'id,en,nl,jv',
        'PG,TL,MY',
        'Indonesia is a country in Southeast Asia, between the Indian and Pacific oceans. It is the world\'s largest island country, with more than seventeen thousand islands, and at 1,904,569 square kilometres (735,358 square miles), the 14th largest by land area and 7th in the combined sea and land area. With over 261 million people, it is the world\'s 4th most populous country as well as the most populous Muslim-majority country. Java, the world\'s most populous island, is home to more than half of the country\'s population.'
    ),
    (
        'IE',
        '372',
    ...
    (
        ...
        'CH,VA,SI,SM,FR,AT',
        'Italy is a unitary parliamentary republic in Southern Europe. To the north, it borders France, Switzerland, Austria, and Slovenia along the Alps. To the south, it consists of the entirety of the Italian Peninsula, Sicily, Sardinia and many other smaller islands. The independent states of San Marino and the Vatican City are enclaves within Italy, while Campione d\'Italia is an Italian exclave in Switzerland. The territory of Italy covers some 301,338 km2 (116,347 sq mi) and is influenced by a temperate seasonal climate. With 60.8 million inhabitants, it is the fifth most populous country in Europe, and the 23rd most populous in the world.'
    ),
    (
        'JE',
        '832',
    ...
    (
        ...
        'sv-SE,se,sma,fi-SE',
        'NO,FI',
        'Sweden is a country in Northern Europe. It borders Norway to the west and north and Finland to the east, and is connected to Denmark in the southwest by a bridge-tunnel across the Oresund Strait. At 450,295 square kilometres (173,860 sq mi), Sweden is the largest country in Northern Europe, the third-largest country in the European Union and the fifth largest country in Europe by area. The capital city is Stockholm. Sweden has a total population of 10.3 million of which 2.5 million have a foreign background. It has a low population density of 22 inhabitants per square kilometre (57/sq mi) and the highest urban concentration is in the central and southern half of the country.'
    ),
    (
        'SG',
        '702',
    ...
    (
        ...
        'Ukraine is a country in Eastern Europe. Excluding Crimea, Ukraine has a population of about 42 million, making it the 32nd most populous country in the world. Its capital and largest city is Kiev. Ukrainian is the official language and its alphabet is Cyrillic. The dominant religion in the country is Eastern Orthodoxy. Ukraine is currently in a territorial dispute with Russia over the Crimean Peninsula, which Russia annexed in 2014. Including Crimea, Ukraine has an area of 603,628 km2 (233,062 sq mi), making it the largest country entirely within Europe and the 46th largest country in the world.'
    ),
    (
        'UG',
        '800',
...
CREATE TABLE `imagedetails` (
    ...
    `CityCode` int DEFAULT NULL,
    `CountryCodeISO` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `ContinentCode` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `Path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `Exif` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    `ActualCreator` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `CreatorURL` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `SourceURL` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `Colors` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    PRIMARY KEY (`ImageID`),
...
VALUES (
        ...
        'NA',
        '48844390243.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D810\", \"exposure_time\":\"1/40\", \"aperture\":\"1.8\", \"focal_length\":\"35.0\", \"iso\": 450 }',
        'Robert Boschman',
        'https://www.robertboschman.com/',
        '',
        '[ \"#332D26\", \"#615C5E\", \"#66502D\", \"#B09E86\", \"#D2CFD3\" ] '
    ),
    (
        2,
        1,
        ...
        '',
        'Denisse Leon',
        'https://unsplash.com/@denisseleon',
        'https://unsplash.com/photos/4ZPrc2__Kr0',
        '[ \"#8E3533\", \"#FCFCF8\", \"#837E79\", \"#B1665F\", \"#5C1211\" ] '
    ),
    (
        3,
        2,
        ...
        'NA',
        '48844533598.jpg',
        '{ \"make\": \"Apple\", \"model\": \"iPhone X\", \"exposure_time\": \"1/2700\", \"aperture\": \"1.8\", \"focal_length\": \"4.0\", \"iso\": 25 }',
        'Steph Smith',
        'https://unsplash.com/@stephsmith',
        'https://unsplash.com/photos/UACBRD8MUic',
        '[ \"#82BCCF\", \"#A0D5E4\", \"#0C424A\", \"#353D3E\", \"#DCECF1\" ] '
    ),
    (
        4,
        2,
        ...
        'NA',
        '48844940962.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D810\", \"exposure_time\":\"1/40\", \"aperture\":\"1.8\", \"focal_length\":\"35.0\", \"iso\": 800 }',
        'Robert Boschman',
        'https://www.robertboschman.com/',
        '',
        '[ \"#2F2A28\", \"#060504\", \"#3F3734\", \"#A29899\", \"#C2BCCA\" ] '
    ),
    (
        5,
        5,
        'Ascending Sulpher Mountain',
        'First time using HDR with 2 stop bracketing composed in PhotoMatix Pro 4.1',
        51.149579,
        -115.559993,
        5892532,
        'CA',
        'NA',
        '6114904363.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon EOS 30D\", \"exposure_time\":\"1/1600\", \"aperture\":\"5.6\", \"focal_length\":\"64.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/6114904363',
        '[ \"#3C422F\", \"#707370\", \"#0E140D\", \"#2F68A2\", \"#4A7FB2\" ] '
    ),
    (
        6,
        5,
        ...
        'NA',
        '6115455110.JPG',
        '{ \"make\":\"Canon\", \"model\":\"Canon EOS 30D\", \"exposure_time\":\"1/1250\", \"aperture\":\"5.6\", \"focal_length\":\"17.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/6115455110',
        '[ \"#4F6A8B\", \"#7E93A7\", \"#68713A\", \"#36421E\", \"#BFC9D2\" ] '
    ),
    (
        7,
        25,
        ...
        'NA',
        '5856697109.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/1000\", \"aperture\":\"4.0\", \"focal_length\":\"11.6\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5856697109',
        '[ \"#472B21\", \"#6A4E3E\", \"#D36D43\", \"#2D4772\", \"#CCCDBC\" ] '
    ),
    (
        8,
        13,
        'Central United Church',
        'Central United Church is a large, late nineteenth-century building on Cumberland Street, across from the Town Square, that has become a landmark in the Old Town Heritage Conservation District of Lunenburg, N.S. ',
        44.377596,
        -64.309123,
        6062069,
        'CA',
        'NA',
        '5856658791.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/640\", \"aperture\":\"4.0\", \"focal_length\":\"6.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5856658791',
        '[ \"#01798A\", \"#432E27\", \"#0FA5A9\", \"#5F4B3A\", \"#6DBAAC\" ] '
    ),
    (
        9,
        11,
        ...
        'NA',
        '5856616479.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/250\", \"aperture\":\"4.0\", \"focal_length\":\"9.1\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5856616479',
        '[ \"#D1D7D9\", \"#0C0C04\", \"#ABABA2\", \"#3B420F\", \"#6E7D17\" ] '
    ),
    (
        10,
        13,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5856654945',
        '[ \"#633E12\", \"#E5E8DD\", \"#AB8439\", \"#9BB7B0\", \"#2B7393\" ] '
    ),
    (
        11,
        11,
        'Annapolis Royal',
        'Outside the Fort Anne National Historic Site and Museum',
        44.741658,
        -65.519307,
        5939236,
        'CA',
        'NA',
        '5857298322.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/200\", \"aperture\":\"4.0\", \"focal_length\":\"24.5\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5857295224',
        '[ \"#4E4A0C\", \"#C7CED0\", \"#FAE7C2\", \"#BACBD8\", \"#655616\" ] '
    ),
    (
        12,
        25,
        ...
        'NA',
        '48848276841.jpg',
        '{ \"make\": \"NIKON CORPORATION\", \"model\": \"NIKON D5500\", \"exposure_time\": \"1/125\", \"aperture\": \"7.1\", \"focal_length\": \"13.0\", \"iso\": 2500}',
        'Riley Sharp',
        'https://unsplash.com/@rileysharp_',
        'https://unsplash.com/photos/do7TsnMD3Kw',
        '[ \"#26303C\", \"#08080A\", \"#1F0809\", \"#7B8176\", \"#E7F3F2\" ] '
    ),
    (
        13,
        5,
        'Central Park',
        'Conservatory Pond in Central Park New York',
        40.773684,
        -73.96701,
        5128581,
        'US',
        'NA',
        '48847989166.jpg',
        '{ \"make\": \"Canon\", \"model\": \"Canon EOS 5D Mark II\", \"exposure_time\": \"1/800\", \"aperture\": \"4.0\", \"focal_length\": \"35.0\", \"iso\": 100 }',
        'Josh Couch',
        'https://unsplash.com/@joshcouchdesign',
        'https://unsplash.com/photos/qjN-uw6YibY',
        '[ \"#7A99AD\", \"#4E331C\", \"#C0C6C2\", \"#8D501C\", \"#A77A4B\" ] '
    ),
    (
        14,
        5,
        ...
        '',
        'ben o\'bro',
        'https://unsplash.com/@benobro',
        'https://unsplash.com/photos/wpU4veNGnHg',
        '[ \"#6D5142\", \"#66B5C2\", \"#96BBC3\", \"#C1A186\", \"#0AB4C9\" ] '
    ),
    (
        15,
        9,
        ...
        'EU',
        '5855174537.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/1600\", \"aperture\":\"2.7\", \"focal_length\":\"7.2\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5855174537',
        '[ \"#BE9C73\", \"#DFC292\", \"#81B9DB\", \"#6C4437\", \"#F3EBCF\" ] '
    ),
    (
        16,
        9,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5855735700',
        '[ \"#E5AA98\", \"#0F8084\", \"#060E13\", \"#60C4D7\", \"#0E414F\" ] '
    ),
    (
        17,
        27,
        ...
        'EU',
        '5855191275.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/1000\", \"aperture\":\"4.0\", \"focal_length\":\"35.4\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5855191275',
        '[ \"#59532E\", \"#F4F4E6\", \"#BAD9F3\", \"#C6BF9C\", \"#0B7CCE\" ] '
    ),
    (
        18,
        27,
        'Wellington\'s Arch',
        'The top of Wellington\'s Arch has this sculptural grouping',
        51.502572,
        -0.150869,
        2643743,
        'GB',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5855752464',
        '[ \"#F1F5F7\", \"#080705\", \"#D2E0E9\", \"#98825D\", \"#AFC7D9\" ] '
    ),
    (
        19,
        27,
        ...
        'EU',
        '5855729828.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/400\", \"aperture\":\"4.0\", \"focal_length\":\"6.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5855729828',
        '[ \"#BBC798\", \"#D3DAA6\", \"#342A24\", \"#504839\", \"#716D50\" ] '
    ),
    (
        20,
        28,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5855221959',
        '[ \"#011C85\", \"#D5C4A4\", \"#8F7656\", \"#F0E8D7\", \"#0260F1\" ] '
    ),
    (
        21,
        28,
    ...
    (
        ...
        18,
        'View of Cologne',
        'View of Cologne from atop the Cologne Cathedral',
        50.941149,
        6.957358,
        2886242,
        'DE',
        'EU',
        '6114850721.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/1000\", \"aperture\":\"4.0\", \"focal_length\":\"8.3\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/6114850721',
        '[ \"#2C130D\", \"#F1EFE5\", \"#4B3227\", \"#635445\", \"#837D67\" ] '
    ),
    (
        23,
        18,
        'Prinz-Georg Garten',
        'The palace is in the Rococo style, made for Prince Georg William. Friedrich Ludwig von Sckell was involved with the design of the informal garden.',
        49.87872,
        8.654719,
        2938913,
        'DE',
        'EU',
        '6114859969.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/1600\", \"aperture\":\"2.7\", \"focal_length\":\"6.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/6114859969',
        '[ \"#381C12\", \"#5E4225\", \"#016182\", \"#084157\", \"#B5C5B6\" ] '
    ),
    (
        24,
        20,
        'Downtown Frankfurt',
        'Downtown Frankfurt from the Frankfurt Cathedral',
        50.110647,
        8.684955,
        2925533,
        'DE',
        'EU',
        '6114960821.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/60\", \"aperture\":\"3.5\", \"focal_length\":\"20.7\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/6114960821',
        '[ \"#E5D6E3\", \"#FAF8FA\", \"#6A6164\", \"#DDA96A\", \"#C0B0B0\" ] '
    ),
    (
        25,
        10,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/6114881215',
        '[ \"#080101\", \"#2D0904\", \"#4B200E\", \"#E9E4D2\", \"#D5CEB5\" ] '
    ),
    (
        26,
        10,
        'Outside the Berliner Dom',
        ...
        'EU',
        '6115603234.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/800\", \"aperture\":\"3.2\", \"focal_length\":\"9.5\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/6115603234',
        '[ \"#4C2610\", \"#2B0F05\", \"#654326\", \"#DCD9D3\", \"#B6A076\" ] '
    ),
    (
        27,
        10,
        'New National Gallery, Berlin',
        'Exterior of the Mies van der Rohe designed New National Gallery',
        52.506482,
        13.367899,
        2950159,
        'DE',
        'EU',
        '6114867983.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/80\", \"aperture\":\"4.0\", \"focal_length\":\"6.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/6114867983',
        '[ \"#060201\", \"#502B14\", \"#F8F8F7\", \"#64462A\", \"#E2E2D3\" ] '
    ),
    (
        28,
        10,
        ...
        'https://www.flickr.com/photos/randyconnolly',
        NULL,
        '[ \"#0E130F\", \"#AFB4B2\", \"#535B57\", \"#32352D\", \"#999A93\" ] '
    ),
    (
        29,
        29,
        ...
        'EU',
        '5855209453.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/60\", \"aperture\":\"3.5\", \"focal_length\":\"6.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5855209453',
        '[ \"#F5F8F6\", \"#030302\", \"#CCC7BB\", \"#62584B\", \"#332C23\" ] '
    ),
    (
        30,
        29,
        'Santiago Bernabeu, Madrid',
        'Home stadium for Real Madrid',
        40.452891,
        -3.689813,
        3117735,
        'ES',
        'EU',
        '5855213165.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/320\", \"aperture\":\"4.0\", \"focal_length\":\"25.2\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/5855213165',
        '[ \"#CBE5ED\", \"#AA9B7D\", \"#6F5955\", \"#C6BEA1\", \"#21131A\" ] '
    ),
    (
        31,
        30,
        'Paradise Island in Nassau',
        'Photographed from Atlantis Bridge; Paradise Island in Nassau, Bahamas',
        25.077709,
        -77.324127,
        3571824,
        'BS',
        'NA',
        '6119127716.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S3 IS\", \"exposure_time\":\"1/200\", \"aperture\":\"4.0\", \"focal_length\":\"6.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        NULL,
        '[ \"#C8D1BD\", \"#9BC9C8\", \"#6DB5C0\", \"#6C5B53\", \"#0F4661\" ] '
    ),
    (
        32,
        30,
        'Castaway Cay, South Abaco',
        ...
        'https://www.flickr.com/photos/randyconnolly',
        NULL,
        '[ \"#4CC8DB\", \"#07B5D4\", \"#757146\", \"#424829\", \"#A29A72\" ] '
    ),
    (
        33,
        6,
        'Disney Coronado Resort',
        'Set beside man-made Lago Dorado, this Spanish colonial-themed resort is 3 miles from Disney\'s Animal Kingdom and 22 miles from Orlando International Airport. ',
        28.365272,
        -81.572183,
        4167147,
        'US',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/6119143988',
        '[ \"#BCCEE2\", \"#221F15\", \"#E7EEF0\", \"#9E5716\", \"#EE9947\" ] '
    ),
    (
        34,
        3,
        ...
        NULL,
        NULL,
        '[ \"#7CAFDD\", \"#9AB0C3\", \"#5B8CAA\", \"#3A5258\", \"#8BB4D7\" ] '
    ),
    (
        35,
        3,
        ...
        NULL,
        NULL,
        '[ \"#8E8974\", \"#A6BDCD\", \"#BDF9FB\", \"#7C7725\", \"#3B3B1A\" ] '
    ),
    (
        36,
        3,
        ...
        NULL,
        NULL,
        '[ \"#D8E1E6\", \"#646252\", \"#7E7B6A\", \"#EBF0F3\", \"#28271C\" ] '
    ),
    (
        37,
        16,
        ...
        'AF',
        '48860768611.jpg',
        '{ \"make\": \"NIKON CORPORATION\",\"model\": \"NIKON D3200\",\"exposure_time\": \"1/640\",\"aperture\": \"5.6\",\"focal_length\": \"17.0\",\"iso\": 100 }',
        'Adrian Dascal',
        'ttps://unsplash.com/@dascal',
        'https://unsplash.com/photos/27a_s3DdbVc',
        '[ \"#7E5E4C\", \"#967560\", \"#90B7BD\", \"#83ADB5\", \"#A2B8B9\" ] '
    ),
    (
        38,
        3,
        ...
        NULL,
        NULL,
        '[ \"#9DAAAF\", \"#F2FDFD\", \"#DFF1F7\", \"#413D2B\", \"#AEBABE\" ] '
    ),
    (
        39,
        3,
        ...
        NULL,
        NULL,
        '[ \"#A8B4BA\", \"#9B9989\", \"#7E7E71\", \"#423E34\", \"#946034\" ] '
    ),
    (
        40,
        27,
        ...
        'EU',
        '48833316971.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/400\", \"aperture\":\"16.0\", \"focal_length\":\"13.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/48833316971',
        '[ \"#6A6860\", \"#0271B2\", \"#827F76\", \"#3B3833\", \"#5989A7\" ] '
    ),
    (
        41,
        27,
        'Bologna Tracks',
        'Bologna looking towards the central train station from the Strada Statale Porrettana',
        44.504041,
        11.353663,
        3181928,
        'IT',
        'EU',
        '48833317116.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/400\", \"aperture\":\"6.3\", \"focal_length\":\"35.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/48833317116',
        '[ \"#2C2B22\", \"#F7F5EC\", \"#EEEADB\", \"#7A7568\", \"#AEA694\" ] '
    ),
    (
        42,
        17,
        ...
        'EU',
        '9493997865.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/160\", \"aperture\":\"5.0\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9493997865',
        '[ \"#987C63\", \"#E3DDD7\", \"#493624\", \"#84B5DA\", \"#B59C86\" ] '
    ),
    (
        43,
        17,
        ...
        'EU',
        '9496787858.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/320\", \"aperture\":\"7.1\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9496787858',
        '[ \"#6F6C6B\", \"#40342D\", \"#A5A6AA\", \"#5F7D9F\", \"#CFC8C4\" ] '
    ),
    (
        44,
        17,
        ...
        'EU',
        '9496792166.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/20\", \"aperture\":\"3.5\", \"focal_length\":\"14.0\", \"iso\": 3200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9496792166',
    ...
    (
        ...
        'EU',
        '9496799098.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/320\", \"aperture\":\"10.0\", \"focal_length\":\"31.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9496799098',
        '[ \"#979688\", \"#494D31\", \"#356399\", \"#846C4F\", \"#E1B086\" ] '
    ),
    (
        46,
        17,
        ...
        'EU',
        '9494282329.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/4000\", \"aperture\":\"18.0\", \"focal_length\":\"14.0\", \"iso\": 6400 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9494282329',
        '[ \"#40668E\", \"#869CAE\", \"#676B54\", \"#BFB7AE\", \"#424634\" ] '
    ),
    (
        47,
        8,
        ...
        'EU',
        '9494475161.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/400\", \"aperture\":\"9.0\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9494475161',
        '[ \"#A27B6B\", \"#EAE4E1\", \"#7D5751\", \"#553333\", \"#9C868C\" ] '
    ),
    (
        48,
        8,
        ...
        'EU',
        '9494472443.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/400\", \"aperture\":\"8.0\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9494472443',
        '[ \"#73614C\", \"#867767\", \"#BAA591\", \"#161109\", \"#F1DCC6\" ] '
    ),
    (
        49,
        8,
    ...
    (
        ...
        'EU',
        '9494470337.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/500\", \"aperture\":\"9.0\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9494470337',
        '[ \"#747160\", \"#36476E\", \"#654930\", \"#C3683C\", \"#838BAA\" ] '
    ),
    (
        51,
        8,
        ...
        'EU',
        '9496560520.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/160\", \"aperture\":\"6.3\", \"focal_length\":\"23.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9496560520',
        '[ \"#CBCAC9\", \"#59453A\", \"#3C3029\", \"#E7A98E\", \"#476581\" ] '
    ),
    (
        52,
        17,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9498368556',
        '[ \"#AA9E97\", \"#B6C6D7\", \"#749CCC\", \"#AE9963\", \"#524F44\" ] '
    ),
    (
        53,
        17,
        'Inside the Colosseum',
        'View from within the The Colosseum or Coliseum, an oval amphitheatre in the centre of the city of Rome, Italy. Built of travertine limestone, tuff (volcanic rock), and brick-faced concrete, it was the largest amphitheatre ever built at the time and held 50,000 spectators. The Colosseum is situated just east of the Roman Forum. Construction began under the emperor Vespasian in AD 72 and was completed in AD 80 under his successor and heir, Titus. Further modifications were made during the reign of Domitian (81–96). These three emperors are known as the Flavian dynasty, and the amphitheatre was named in Latin for its association with their family name ',
        41.890332,
        12.49181,
        3169070,
        'IT',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9495571869',
        '[ \"#916244\", \"#6C4833\", \"#452F22\", \"#8E99B6\", \"#EABE9B\" ] '
    ),
    (
        54,
        17,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9495574327',
        '[ \"#4D3C2F\", \"#B29479\", \"#E4C9AF\", \"#02488D\", \"#0A72C3\" ] '
    ),
    (
        55,
        17,
        'Palatine Hill',
        'Walking up the via di San Gregorio side of the Hill',
        41.887437,
        12.48866,
        3169070,
        'IT',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9498381010',
        '[ \"#4D4F29\", \"#787342\", \"#9E8F63\", \"#6C94CA\", \"#4C7EBA\" ] '
    ),
    (
        56,
        17,
        ...
        'EU',
        '9498386718.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/200\", \"aperture\":\"6.3\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9498386718',
        '[ \"#6B5C4F\", \"#948476\", \"#B2987F\", \"#3D3329\", \"#D8B797\" ] '
    ),
    (
        57,
        4,
        'Temple of Asclepius',
        'In the Villa Borghese Park',
        41.914541,
        12.483443,
        3169070,
        'IT',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9498388516',
        '[ \"#021432\", \"#022555\", \"#3E3E13\", \"#6A611E\", \"#265A91\" ] '
    ),
    (
        58,
        22,
        'Florence Duomo',
        'Photo taken from the Campanile. The Florence Cathedral, formally the Cattedrale di Santa Maria del Fiore, is the cathedral of Florence, Italy. It was begun in 1296 in the Gothic style to a design of Arnolfo di Cambio and was structurally completed by 1436, with the dome designed by Filippo Brunelleschi.',
        43.772801,
        11.255673,
        3176959,
        'IT',
        'EU',
        '9498358806.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/400\", \"aperture\":\"10.0\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9498358806',
        '[ \"#5F3E26\", \"#926543\", \"#6371AE\", \"#DCCDC9\", \"#3B4F85\" ] '
    ),
    (
        59,
        22,
        'Orpheus Fountain, Florence',
        'In the garden of Palazzo Vivarelli Colonna',
        43.76964,
        11.266535,
        3176959,
        'IT',
        'EU',
        '9504606628.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/250\", \"aperture\":\"6.3\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9504606628',
        '[ \"#CEBC9E\", \"#54502D\", \"#837550\", \"#6994CF\", \"#477FC2\" ] '
    ),
    (
        60,
        22,
        'Pazzi Chapel at Santa Croce',
        'By Filippo Brunelleschi, the chapel is considered to be one of the masterpieces of Renaissance architecture. It is located in the first cloister of the Basilica di Santa Croce.',
        43.768234,
        11.262212,
        3176959,
        'IT',
        'EU',
        '9504609042.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/2000\", \"aperture\":\"11.0\", \"focal_length\":\"14.0\", \"iso\": 3200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9504609042',
        '[ \"#575235\", \"#8E7D58\", \"#C6AB80\", \"#EADCC6\", \"#6B88AD\" ] '
    ),
    (
        61,
        12,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9504613978',
        '[ \"#32271D\", \"#60626C\", \"#D5D3D0\", \"#593C19\", \"#46464D\" ] '
    ),
    (
        62,
        12,
        'Interior Santo Spirito, Florence',
        'Filippo Brunelleschi designed church has been called by Bernini the most beautiful church in the world. I have to concur with the master, it is beyond stunning …',
        43.767212,
        11.248202,
        3176959,
        'IT',
        'EU',
        '9504451722.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/60\", \"aperture\":\"3.5\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9504451722',
        '[ \"#3C2A1A\", \"#815F43\", \"#A79E98\", \"#9C7F67\", \"#74787C\" ] '
    ),
    (
        63,
        12,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9504449928',
        '[ \"#E3A465\", \"#95643D\", \"#3B7AF4\", \"#2D61D5\", \"#224CB1\" ] '
    ),
    (
        64,
        15,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9504448540',
        '[ \"#737730\", \"#464F1F\", \"#B9A183\", \"#3981B9\", \"#7CA7CC\" ] '
    ),
    (
        65,
        15,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9504445110',
        '[ \"#65605D\", \"#393E28\", \"#012F6B\", \"#025FAF\", \"#2B7EC2\" ] '
    ),
    (
        66,
        15,
        ...
        'EU',
        '9505536014.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/1000\", \"aperture\":\"3.5\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9505536014',
        '[ \"#C4B804\", \"#F9FAF3\", \"#838205\", \"#DECB87\", \"#5E6746\" ] '
    ),
    (
        67,
        15,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9502740177',
        '[ \"#4A641D\", \"#4B5158\", \"#72757A\", \"#085B99\", \"#4A86BE\" ] '
    ),
    (
        68,
        23,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9502741759',
        '[ \"#3E4349\", \"#989392\", \"#62869F\", \"#374B1A\", \"#2B6B92\" ] '
    ),
    (
        69,
        23,
        ...
        'EU',
        '9505893300.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/125\", \"aperture\":\"5.0\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/9505893300',
        '[ \"#2E577B\", \"#4B3E31\", \"#8CADC9\", \"#76695A\", \"#CF9048\" ] '
    ),
    (
        70,
        23,
    ...
    (
        ...
        'EU',
        '8730408907.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/640\", \"aperture\":\"10.0\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8730408907',
        '[ \"#A0A1B1\", \"#584737\", \"#D7B38D\", \"#AE6D2A\", \"#CCC3C6\" ] '
    ),
    (
        72,
        7,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8731523536',
        '[ \"#DBC0AB\", \"#98ACCF\", \"#E0DCDD\", \"#3B3535\", \"#6D5746\" ] '
    ),
    (
        73,
        7,
        'Ekklisia Agii Isidori church',
        'At the top of the Lycabettus Hill',
        37.981905,
        23.743295,
        264371,
        'GR',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8710320515',
        '[ \"#B6ABA1\", \"#032D6B\", \"#DFCCBC\", \"#03499A\", \"#107CCD\" ] '
    ),
    (
        74,
        14,
        'Temple of Hephaistos',
        'Located on western perimeter of Agora in Athens. Built in 460-415 BCE, it is the best preserved temple of antiquity.',
        37.975579,
        23.721526,
        264371,
        'GR',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8711645510',
        '[ \"#695C4E\", \"#58551F\", \"#5A8BCC\", \"#909AB5\", \"#262413\" ] '
    ),
    (
        75,
        14,
        'Ancient Theatre of Dionysos',
        'On south bank of Acropolis',
        37.970657,
        23.727309,
        264371,
        'GR',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8710513053',
        '[ \"#B99C5D\", \"#A8C0D0\", \"#937D2C\", \"#545133\", \"#5484AE\" ] '
    ),
    (
        76,
        12,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8711623884',
        '[ \"#C9CAD4\", \"#44371B\", \"#809CCC\", \"#735E34\", \"#1E64A9\" ] '
    ),
    (
        77,
        12,
        'Dusk on Imerovigli (Santorini)',
        ...
        'EU',
        '8710247776.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/250\", \"aperture\":\"8.0\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8710247776',
        '[ \"#221711\", \"#503B37\", \"#0B4158\", \"#022339\", \"#E08C37\" ] '
    ),
    (
        78,
        7,
        ...
        'EU',
        '8710289254.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/320\", \"aperture\":\"9.0\", \"focal_length\":\"26.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8710289254',
        '[ \"#88ADC9\", \"#9FA9B4\", \"#675B55\", \"#E1C6A6\", \"#947B66\" ] '
    ),
    (
        79,
        29,
        'Besides the Mauritshuis',
        'In The Hague in January',
        52.081038,
        4.313039,
        2747373,
        'NL',
    ...
    (
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8731526170',
        '[ \"#3B3A19\", \"#64660D\", \"#868C9A\", \"#535A63\", \"#EAC282\" ] '
    ),
    (
        81,
        19,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8645912379',
        '[ \"#BABBBF\", \"#514821\", \"#7A7058\", \"#C5C709\", \"#8A850C\" ] '
    ),
    (
        82,
        19,
        'Cloisters, New College, Oxford',
        'New College is one of the constituent colleges of the University of Oxford in the United Kingdom. Founded in 1379 by William of Wykeham, the full name of the college is St Mary\'s College of Winchester in Oxford.',
        51.754369,
        -1.252417,
        2640729,
        'GB',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/8646991554',
        '[ \"#B3AF02\", \"#505128\", \"#6D703F\", \"#E9E9C8\", \"#828905\" ] '
    ),
    (
        83,
        16,
        ...
        'EU',
        '15108090436.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/500\", \"aperture\":\"10.0\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/15108090436',
        '[ \"#756760\", \"#3180E1\", \"#7C9FCC\", \"#928581\", \"#475D7A\" ]'
    ),
    (
        84,
        16,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/15128113051',
        '[ \"#060705\", \"#C2C6CF\", \"#827F86\", \"#6C605F\", \"#F0F1F2\" ] '
    ),
    (
        85,
        19,
        ...
        'EU',
        '15127898611.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot SX30\", \"exposure_time\":\"1/800\", \"aperture\":\"4.0\", \"focal_length\":\"4.3\", \"iso\": 800 }',
        'Norm Connolly',
        '',
        'https://www.flickr.com/photos/randyconnolly/15127898611',
        '[ \"#D2D5C8\", \"#6F684E\", \"#2692BC\", \"#B8A67B\", \"#433F2E\" ] '
    ),
    (
        86,
        19,
        'KNSM Island',
        'The KNSM Island is a man-made island in the Eastern Docklands of Amsterdam. It is named for the Koninklijke Nederlandsche Stoomboot-Maatschappij (KNSM), the Royal Dutch Steamboat Shipping company which used to have its headquarters and its docks on the island. It is now a large residential area containing modern architecture with a mostly well-off population.',
        52.377903,
        4.929589,
        2759794,
        'NL',
        'EU',
        '15130505782.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/200\", \"aperture\":\"5.6\", \"focal_length\":\"14.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/15130505782',
        '[ \"#76635A\", \"#544136\", \"#994D32\", \"#C1B2A1\", \"#C55E34\" ] '
    ),
    (
        87,
        26,
        ...
        'EU',
        '21584214296.jpg',
        '{ \"make\":\"Olympus\", \"model\":\"Olympus E-PM2\", \"exposure_time\":\"1/250\", \"aperture\":\"9.0\", \"focal_length\":\"28.0\", \"iso\": 200 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/21584214296',
        '[ \"#A1A3A8\", \"#807F7D\", \"#35342D\", \"#235C71\", \"#6B665D\" ] '
    ),
    (
        88,
        26,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/20987595084',
        '[ \"#726A09\", \"#CDC39F\", \"#5A4A1C\", \"#AA801C\", \"#C59B38\" ] '
    ),
    (
        89,
        24,
        ...
        'NA',
        '19482907064.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/80\", \"aperture\":\"10.0\", \"focal_length\":\"13.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/19482907064',
        '[ \"#D3E2F6\", \"#4F5737\", \"#2E3B1F\", \"#686F75\", \"#8D9568\" ] '
    ),
    (
        90,
        24,
        'A-maze-ing Laughter',
        'A-maze-ing Laughter is a 2009 bronze sculpture by Yue Minjun, located in Morton Park in Vancouver near English Bay',
        49.287529,
        -123.141847,
        6173331,
        'CA',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/19919266559',
        '[ \"#5D4D3D\", \"#362D22\", \"#7289B8\", \"#E6DCD9\", \"#B1C1E7\" ] '
    ),
    (
        91,
        21,
        ...
        'NA',
        '20991329924.jpg',
        '{ \"make\":\"Samsung\", \"model\":\"Samsung SGH-1747M\", \"exposure_time\":\"1/700\", \"aperture\":\"2.6\", \"focal_length\":\"3.7\", \"iso\": 80 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/20991329924',
        '[ \"#CDD2BA\", \"#F6F6EC\", \"#38292E\", \"#DA6F60\", \"#9E2429\" ] '
    ),
    (
        92,
        21,
        'EMP Museum',
        'The Museum’s mission is to make creative expression a life-changing force by offering experiences that inspire and connect our communities.',
        47.621349,
        -122.348803,
        5809844,
        'US',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/21587937686',
        '[ \"#DBCAB2\", \"#C2AC90\", \"#353842\", \"#635250\", \"#436062\" ] '
    ),
    (
        93,
        21,
        'Painted Victorian Houses, Haight, Haight-Ashbury',
        'Battirent suspendue ah on corbeille concierge petillent ai. On disait tuiles frenes du jurons. Vivant fer chemin simple mourir nez enfuit suivit. La frequentes infanterie descendons la he la. Frisottent tu on approchait la nationales comprendre or. Le puissions sa mystiques ma sacrifice effrayant la.',
        37.77093,
        -122.441002,
        5391959,
        'US',
        'NA',
        '23959634814.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D80\", \"exposure_time\":\"1/125\", \"aperture\":\"5.6\", \"focal_length\":\"28.0\", \"iso\": 200 }',
        'Michael Gouthro',
        NULL,
        NULL,
        '[ \"#F4FCFB\", \"#84837D\", \"#4E5C69\", \"#4E5C69\", \"#D0EFF8\" ] '
    ),
    (
        94,
        21,
        ...
        'NA',
        '24292302290.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D80\", \"exposure_time\":\"1/250\", \"aperture\":\"8.0\", \"focal_length\":\"44.0\", \"iso\": 100 }',
        'Michael Gouthro',
        NULL,
        NULL,
        '[ \"#A3A19E\", \"#605E55\", \"#040307\", \"#CDD0D0\", \"#A5A5A5\" ] '
    ),
    (
        95,
        20,
    ...
    (
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/22165883251',
        '[ \"#B2B1B2\", \"#3D3C33\", \"#55544C\", \"#BCBABB\", \"#242516\" ] '
    ),
    (
        97,
        18,
        'Montreal Skyline',
        'Ate ira bemdizer fingindo objectou sciencia cre occultes morteque. Tu fortuna ah de retendo resisto manhoso aquella. Lei paz afogar menina ves vicios sequer. Ama guardou suggere ate arresto vencida deveres. Um ja tome pola cara sera alem. Namoro meu nao fiquei dei punham vel intima. Vida iii foi ceo acha voos cre. Horas uma ate puxou era globo dao. No notou fiaes eu ao livre legou. Duzias serena lh podeis ja lancar.',
        45.503621,
        -73.586769,
        6077243,
        'CA',
        'NA',
        '28787532651.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/320\", \"aperture\":\"9.0\", \"focal_length\":\"18.0\", \"iso\": 320 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/28787532651',
        '[ \"#584F4E\", \"#A7C7DE\", \"#2481D3\", \"#57A9E6\", \"#818488\" ] '
    ),
    (
        98,
        18,
        'Parliament in the January Snow',
        'Frenesi vim batente tom parecia. Vez aproveite tal amo procurava decidiste chamasses bem percorrer. Ja fervoroso succumbas distincta avultados tu franqueza infernaes. Veu emquanto arrancou enviesou mantemos custodio pae dar vez quizeres. Reclamo caveira ja sincera impedir deserta as queriam ja la. No franzindo ja captivava eu continuar ja seitornou. Petroleo faz caminhou dor ler confunda.',
        45.426584,
        -75.696573,
        6094817,
        'CA',
        'NA',
        '28863181765.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"NIKON D7200\", \"exposure_time\":\"1/800\", \"aperture\":\"7.1\", \"focal_length\":\"56.0\", \"iso\": 400 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/28863181765',
        '[ \"#EDEEE2\", \"#DBDCCA\", \"#948C7F\", \"#7A6F68\", \"#3A2C33\" ] '
    ),
    (
        99,
        18,
        'National Gallery of Canada',
        'Fogo jogo deve moem ala dao nas juro. Proferir mo es encobria encontre da. Pancada gazetas ti de curvada levando acoitar. Nas depois pensar mal filhos ver. Vida no voce alli voce eu gado. Tu deixam dictar te desejo so. Patifarias bracejando ha no condemnada no finalmente ha recordarei. Nas espadas dar maioria honrado capital.',
        45.427999,
        -75.698097,
        6094817,
        'CA',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/28758575302',
        '[ \"#BDCAC6\", \"#944E25\", \"#A06138\", \"#440602\", \"#B09374\" ] '
    ),
    (
        100,
        22,
        ...
        NULL,
        NULL,
        '[ \"#292927\", \"#9FA4A4\", \"#596063\", \"#EABFA2\", \"#783221\" ] '
    ),
    (
        101,
        22,
        ...
        NULL,
        NULL,
        '[ \"#4D7592\", \"#405C6E\", \"#A3D2F5\", \"#6F7675\", \"#C7E4F2\" ] '
    ),
    (
        102,
        14,
        'Lake Bled',
        'Lake Bled is a lake in the Julian Alps of the Upper Carniolan region of northwestern Slovenia, where it adjoins the town of Bled. The area is a tourist destination. The lake is 35 km (22 mi) from Ljubljana International Airport and 55 km (34 mi) from the capital city, Ljubljana. The lake lies in a picturesque environment, surrounded by mountains and forests. Medieval Bled Castle stands above the lake on the north shore and has a museum.',
        46.363598,
        14.093805,
        3203925,
        'SI',
        'EU',
        '29053823052.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D80\", \"exposure_time\":\"1/125\", \"aperture\":\"3.6\", \"focal_length\":\"18.0\", \"iso\": 200 }',
        'Michael Gouthro',
        NULL,
        NULL,
        '[ \"#7E9FC1\", \"#1B343E\", \"#667379\", \"#BDC0C5\", \"#6186AD\" ] '
    ),
    (
        103,
        4,
        ...
        'EU',
        '23959679874.jpg',
        '{ \"make\":\"Panasonic\", \"model\":\"Panasonic DMC-LZ2\", \"exposure_time\":\"1/500\", \"aperture\":\"5.6\", \"focal_length\":\"6.0\", \"iso\": 80 }',
        'Emily Girard',
        NULL,
        NULL,
        '[ \"#4F4C44\", \"#605E55\", \"#2A2B25\", \"#CDD0D0\", \"#A5A5A5\" ] '
    ),
    (
        104,
        4,
        ...
        NULL,
        NULL,
        '[ \"#6CA2CD\", \"#BBA394\", \"#273541\", \"#445C63\", \"#624F3D\" ] '
    ),
    (
        105,
        5,
        ...
        'SA',
        '29126221216.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D80\", \"exposure_time\":\"1/100\", \"aperture\":\"9.0\", \"focal_length\":\"22.0\", \"iso\": 200 }',
        'Michael Gouthro',
        NULL,
        NULL,
        '[ \"#3A413A\", \"#4E5657\", \"#E0EAF4\", \"#74755B\", \"#C8D3DF\" ] '
    ),
    (
        106,
        5,
        ...
        NULL,
        NULL,
        '[ \"#695A4F\", \"#50473D\", \"#C5B3A1\", \"#A18C7F\", \"#D1C4B2\" ] '
    ),
    (
        107,
        5,
        ...
        NULL,
        NULL,
        '[ \"#43382A\", \"#6C5A46\", \"#B7A796\", \"#ADBED7\", \"#3F4E63\" ] '
    ),
    (
        108,
        1,
        'Royal Ontario Museum',
        'Michael Lee-Chin Crystal facade was created by architect Daniel Libeskind',
        43.668451,
        -79.394653,
        6167865,
        'CA',
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly/',
        'https://www.flickr.com/photos/randyconnolly/20010830173',
        '[ \"#6B90C0\", \"#4E5010\", \"#836F3D\", \"#4B4C3A\", \"#B19461\" ] '
    ),
    (
        109,
        2,
        'Stykkisholmur Stykkisholmskirkja',
        'The church of Stykkisholmur, Iceland was inaugurated May 6th, 1990. It is a landmark of the small town both from sea and land. The church is designed by architect Jon Haraldsson and the altar piece is painted by icelandic painter Kristin Gunnlaugsdottir and shows Maria carrying the child Jesus. ',
        65.074244,
        -22.721508,
        3412888,
        'IS',
        ...
        NULL,
        NULL,
        '[ \"#9FACBC\", \"#ADB8C7\", \"#C6CDD8\", \"#656E6F\", \"#353E35\" ] '
    ),
    (
        110,
        2,
        'Lying Buddha',
        'Lying Buddha  of Wat Tham Phousi on Mount Phousi (or Phou Si Hill)',
        19.890278,
        102.137064,
        1655559,
        'LA',
        'AS',
        '30211625336.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S95\", \"exposure_time\":\"1/125\", \"aperture\":\"3.2\", \"focal_length\":\"4.3\", \"iso\": 400 }',
        'Sonya Flessati',
        NULL,
        NULL,
        '[ \"#BCBEBD\", \"#8C8980\", \"#524B3C\", \"#CED5DA\", \"#46536C\" ] '
    ),
    (
        111,
        2,
        ...
        NULL,
        NULL,
        '[ \"#305487\", \"#496E9F\", \"#DFDFD4\", \"#B9AB68\", \"#435140\" ] '
    ),
    (
        112,
        2,
        ...
        'AS',
        '30211628146.jpg',
        '{ \"make\":\"Canon\", \"model\":\"Canon Powershot S95\", \"exposure_time\":\"1/1000\", \"aperture\":\"5.0\", \"focal_length\":\"6.0\", \"iso\": 400 }',
        'Sonya Flessati',
        NULL,
        NULL,
        '[ \"#A6937D\", \"#423C33\", \"#D6DEE2\", \"#B9C3CA\", \"#92A0A5\" ] '
    ),
    (
        113,
        2,
        'Guanyin',
        'Sixteen armed Buddha at Wat Plai Laem',
        9.570731,
        100.066823,
        1154689,
        'TH',
        ...
        NULL,
        NULL,
        '[ \"#B0ACAF\", \"#9D918C\", \"#E0DFE4\", \"#887062\", \"#3B2920\" ] '
    ),
    (
        114,
        3,
        ...
        'EU',
        '29949949990.jpg',
        '{ \"make\":\"Apple\", \"model\":\"Apple iPhone 5\", \"exposure_time\":\"1/3623\", \"aperture\":\"2.4\", \"focal_length\":\"4.0\", \"iso\": 50 }',
        'Sonya Flessati',
        NULL,
        NULL,
        '[ \"#867F71\", \"#B7BBC3\", \"#CBCED4\", \"#45463D\", \"#979692\" ] '
    ),
    (
        115,
        3,
        ...
        NULL,
        NULL,
        '[ \"#F7F1D1\", \"#383637\", \"#79604E\", \"#A49679\", \"#A46E4D\" ] '
    ),
    (
        116,
        17,
        'Genoa Skyline',
        'Looking towards the Castello d\'Albertis from the roof of the Galata Museo del Mare.',
        44.414146,
        8.923047,
        3176219,
        'IT',
        'EU',
        '48833317311.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/400\", \"aperture\":\"8.0\", \"focal_length\":\"35.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48833317311/',
        '[ \"#24474B\", \"#96A08E\", \"#9EC1C7\", \"#6D605A\", \"#6AA4B6\" ] '
    ),
    (
        117,
        4,
        ...
        'EU',
        '48833318631.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/100\", \"aperture\":\"8.0\", \"focal_length\":\"35.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48833318631',
        '[ \"#4D6478\", \"#8496A4\", \"#304F6B\", \"#24231F\", \"#48453C\" ] '
    ),
    (
        118,
        4,
        ...
        'EU',
        '48835164052.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/100\", \"aperture\":\"7.1\", \"focal_length\":\"35.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48835164052',
        '[ \"#3F403F\", \"#645C54\", \"#A9BEC7\", \"#809CAC\", \"#938467\" ] '
    ),
    (
        119,
        4,
        'Graz Rooftops',
        'Looking down the Schlossbergplatz on the stairs up to the Schlossberg.',
        47.073218,
        15.436882,
        2778067,
        'AT',
        'EU',
        '48834993861.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/100\", \"aperture\":\"7.1\", \"focal_length\":\"16.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48834993861',
        '[ \"#745144\", \"#55382E\", \"#455A79\", \"#808490\", \"#AFAEAF\" ] '
    ),
    (
        120,
        4,
        'Loeben',
        'Leoben is a city in central Austria, located on the Mur river. With a population of about 25,000 it is a local industrial center and hosts the University of Leoben, which specialises in mining. ',
        47.382637,
        15.090455,
        2772649,
        'AT',
        'EU',
        '48832937863.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/100\", \"aperture\":\"8.0\", \"focal_length\":\"11.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48832937863/',
        '[ \"#675F5C\", \"#827A75\", \"#6089B9\", \"#085FA7\", \"#4C5971\" ] '
    ),
    (
        121,
        4,
        'Sunset on the Schlossberg',
        ...
        'EU',
        '48834622803.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/320\", \"aperture\":\"5.0\", \"focal_length\":\"11.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48834622803',
        '[ \"#392420\", \"#4F3B51\", \"#BB93BE\", \"#EECDDE\", \"#E7B1B6\" ] '
    ),
    (
        122,
        7,
        ...
        'EU',
        '48834992811.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/400\", \"aperture\":\"4.5\", \"focal_length\":\"15.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48834992811',
        '[ \"#CEDDE8\", \"#415D7E\", \"#13395C\", \"#2992D6\", \"#7C6D53\" ] '
    ),
    (
        123,
        7,
        ...
        'EU',
        '48834992921.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/800\", \"aperture\":\"4.5\", \"focal_length\":\"15.0\", \"iso\": 100 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48834992921/',
        '[ \"#3F5C6A\", \"#6B8696\", \"#83745F\", \"#A3BDDC\", \"#0C86D9\" ] '
    ),
    (
        124,
        7,
        ...
        'EU',
        '48833485917.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/1800\", \"aperture\":\"2.2\", \"focal_length\":\"4.2\", \"iso\": 25 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48833485917/',
        '[ \"#4E7024\", \"#3472BE\", \"#609BD3\", \"#D3CFB9\", \"#D1A027\" ] '
    ),
    (
        125,
        1,
        ...
        'NA',
        '48848443367.jpg',
        '{ \"make\": \"SONY\", \"model\": \"ILCE-7M3\", \"exposure_time\": \"1/100\", \"aperture\": \"4.5\", \"focal_length\": \"85.0\", \"iso\": 100 }',
        'Dyson Nordwick Chan',
        'https://unsplash.com/@dysonnordwick',
        'https://unsplash.com/photos/B0RqirBfjXA',
        '[ \"#24312B\", \"#2A4D52\", \"#467C89\", \"#B0C1C0\", \"#5A605C\" ] '
    ),
    (
        126,
        1,
        'Calgary Downtown',
        'Shot from Fifth Avenue Place in Calgary',
        51.048671,
        -114.066836,
        5913490,
        'CA',
        'NA',
        '48847890338.jpg',
        '{ \"make\": \"Apple\", \"model\": \"iPhone 8\", \"exposure_time\": \"1/12\", \"aperture\": \"1.8\", \"focal_length\": \"4.0\", \"iso\": 100 }',
        'Philip Davis',
        'https://unsplash.com/@philipsdavis',
        'https://unsplash.com/photos/xgS_WhnGvjE',
        '[ \"#1F2D3D\", \"#5577A1\", \"#325683\", \"#565143\", \"#BBF4F4\" ] '
    ),
    (
        127,
        1,
        ...
        'NA',
        '48847992431.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D810\", \"exposure_time\":\"1/250\", \"aperture\":\"16.0\", \"focal_length\":\"24.0\", \"iso\": 1000 }',
        'Robert Boschman',
        'https://www.robertboschman.com/',
        NULL,
        '[ \"#5F605B\", \"#050504\", \"#4A4B47\", \"#A5A5A2\", \"#D0D0CE\" ] '
    ),
    (
        128,
        8,
        ...
        'NA',
        '48848444312.jpg',
        '{ \"make\": \"Canon\", \"model\": \"Canon EOS 77D\",\"exposure_time\": \"1/80\",\"aperture\": \"4.5\",\"focal_length\": \"18.0\",\"iso\": 200 }',
        'Rachael Annabelle',
        'https://unsplash.com/@knottedbrains',
        'https://unsplash.com/photos/XeYmx-qBsUk',
        '[ \"#EDECEA\", \"#B08D73\", \"#887868\", \"#6A5A4D\", \"#B9C0BC\" ] '
    ),
    (
        129,
        9,
        ...
        'NA',
        '48847890053.jpg',
        '{ \"make\": \"SONY\",\"model\": \"ILCE-7RM2\",\"exposure_time\": \"1/30\",\"aperture\": \"6.3\",\"focal_length\": \"35.0\",\"iso\": 50 }',
        'Ragnar Vorel',
        'https://unsplash.com/@sonuba',
        'https://unsplash.com/photos/o8Utw2ETExA',
        '[ \"#E6E1E5\", \"#4F989F\", \"#2B6F72\", \"#805C36\", \"#AE997D\" ] '
    ),
    (
        130,
        9,
        'In San Jose',
        'On Park Ave facing towards the Adobe headquarters.',
        37.331798,
        -121.890874,
        5392171,
        'US',
        'NA',
        '48848251276.jpg',
        '{ \"make\": \"Canon\",\"model\": \"Canon EOS 550D\",\"exposure_time\": \"1/1600\",\"aperture\": \"4.0\",\"focal_length\": \"16.0\",\"iso\": 100 }',
        'Andrii Ganzevych',
        'https://unsplash.com/@odya_kun',
        'https://unsplash.com/photos/fn_NefXqH5A',
        '[ \"#40292A\", \"#E7B492\", \"#A53428\", \"#A8F4F9\", \"#04BCDE\" ] '
    ),
    (
        131,
        16,
        ...
        'AF',
        '48860308303.jpg',
        '{ \"make\": \"NIKON CORPORATION\",\"model\": \"NIKON D3200\",\"exposure_time\": \"1/400\",\"aperture\": \"5.6\",\"focal_length\": \"46.0\",\"iso\": 100 }',
        'Andrii Ganzevych',
        'https://unsplash.com/@odya_kun',
        'https://unsplash.com/photos/GXIr_uawluA',
        '[ \"#E4E5DF\", \"#8F664C\", \"#71503C\", \"#A77D61\", \"#49342A\" ] '
    ),
    (
        132,
        5,
        ...
        'NA',
        '48847889748.jpg',
        '{ \"make\": \"NIKON CORPORATION\",\"model\": \"NIKON D750\",\"exposure_time\": \"6\",\"aperture\": \"7.1\",\"focal_length\": \"70.0\",\"iso\": 100 }',
        'Casey Horner',
        'https://unsplash.com/@mischievous_penguins',
        'https://unsplash.com/photos/pArjs_G6m4Y',
        '[ \"#DFBCA5\", \"#23231B\", \"#F4B392\", \"#F4B392\", \"#736A64\" ] '
    ),
    (
        133,
        5,
        'Capitol Building',
        'The United States Capitol, often called the Capitol Building, is the home of the United States Congress and the seat of the legislative branch',
        38.889877,
        -77.011426,
        4140963,
        'US',
        ...
        NULL,
        'Matt ',
        'https://unsplash.com/@elevenphotographs',
        'https://unsplash.com/photos/GHXpXhuT5nM',
        '[ \"#B8BAB8\", \"#9EA8AA\", \"#3F0602\", \"#B46F28\", \"#1F311A\" ] '
    ),
    (
        134,
        6,
        ...
        'NA',
        '48848443727.jpg',
        '{ \"make\": \"NIKON CORPORATION\",\"model\": \"NIKON D5500\",\"exposure_time\": \"1/60\",\"aperture\": \"5.6\",\"focal_length\": \"55.0\",\"iso\": 3600 }',
        'Colton Sturgeon',
        'https://unsplash.com/@coltonsturgeon',
        'https://unsplash.com/photos/FiCPutl_aog',
        '[ \"#242B33\", \"#DAD2D6\", \"#8F85A6\", \"#D7A084\", \"#1E4B88\" ] '
    ),
    (
        135,
        6,
        'Michigan Central Train Station',
        'Built in the early 1900s, then abandoned for many years, this train station now has tours & events.',
        42.329321,
        -83.077367,
        4990729,
        'US',
        'NA',
        '48847889453.jpg',
        '{ \"make\": \"Canon\",\"model\": \"Canon EOS Rebel T6i\",\"exposure_time\": \"1/800\",\"aperture\": \"3.5\",\"focal_length\": \"18.0\",\"iso\": 100 }',
        'Doug Zuba',
        'https://unsplash.com/@thezuba',
        'https://unsplash.com/photos/4KGjCArvhgo',
        '[ \"#4A4340\", \"#636266\", \"#C4C1BF\", \"#925D39\", \"#A2A5A8\" ] '
    ),
    (
        136,
        6,
        ...
        'NA',
        '48848442967.jpg',
        '{ \"make\": \"DJI\",\"model\": \"FC300C\",\"exposure_time\": \"1/1500\",\"aperture\": \"2.8\",\"focal_length\": \"3.6\",\"iso\": 100 }',
        'Kahari king',
        'https://unsplash.com/@kahari_king',
        'https://unsplash.com/photos/bt4Vz8fcibU',
        '[ \"#6A4D14\", \"#B0C2CE\", \"#8EAEBE\", \"#2D453D\", \"#A57A59\" ] '
    ),
    (
        137,
        6,
        'Buildings downtown Detroit',
        ...
        '[ \"#DDE0E1\", \"#5D4346\", \"#413233\", \"#B4A8A6\", \"#EBEDEB\" ] '
    ),
    (
        138,
        11,
        'Looking up to the Manhattan Bridge',
        ...
        'NA',
        '48848250506.jpg',
        '{ \"make\": \"Canon\",\"model\": \"Canon EOS 6D\",\"exposure_time\": \"1/320\",\"aperture\": \"6.3\",\"focal_length\": \"35.0\",\"iso\": 800 }',
        'Hieu Vu Minh',
        'https://unsplash.com/@spoony',
        'https://unsplash.com/photos/IRkAbNRT_Yg',
        '[ \"#332D26\", \"#E6E5DA\", \"#4C4236\", \"#695E4D\", \"#B0A893\" ] '
    ),
    (
        139,
        11,
        ...
        'NA',
        '48848442762.jpg',
        '{ \"make\": \"Leica Camera AG\",\"model\": \"LEICA M10\",\"exposure_time\": \"1/125\",\"aperture\": null,\"focal_length\": \"21.0\",\"iso\": 1250 }',
        'Luca Bravo',
        'https://unsplash.com/@lucabravo',
        'https://unsplash.com/photos/TaCk3NspYe0',
        '[ \"#2B2C37\", \"#47291D\", \"#7A4828\", \"#4D4555\", \"#E3613A\" ] '
    ),
    (
        140,
        11,
        'World Trade Center Station',
        'The $4 billion Oculus station house, designed by Santiago Calatrava, consists of white ribs that interlock high above the ground. The interior of the station house contains two underground floors, which house part of the Westfield World Trade Center mall. ',
        40.711568,
        -74.011384,
        5128581,
        'US',
        'NA',
        '48848442862.jpg',
        '{ \"make\": \"Leica Camera AG\",\"model\": \"LEICA M10\",\"exposure_time\": \"1/30\",\"aperture\": null,\"focal_length\": \"18.0\",\"iso\": 500 }',
        'Luca Bravo',
        'https://unsplash.com/@lucabravo',
        'https://unsplash.com/photos/B6-H27CMbGI',
        '[ \"#DBDAD8\", \"#E6E5E3\", \"#E3D0BE\", \"#CAB8A6\", \"#82694E\" ] '
    ),
    (
        141,
        20,
        ...
        'NA',
        '48847888473.jpg',
        '{ \"make\": \"OLYMPUS IMAGING CORP.\",\"model\": \"E-M5\",\"exposure_time\": \"1/2000\",\"aperture\": \"6.3\",\"focal_length\": \"200.0\",\"iso\": 400 }',
        'Pedro Lastra',
        'https://unsplash.com/@peterlaster',
        'https://unsplash.com/photos/f9TWR57Uujo',
        '[ \"#9FC7E8\", \"#68604F\", \"#D5BB9C\", \"#6B611A\", \"#C6923A\" ] '
    ),
    (
        142,
        20,
        ...
        'NA',
        '48848443297.jpg',
        '{ \"make\": \"Apple\",\"model\": \"iPhone 8 Plus\",\"exposure_time\": \"1/2000\",\"aperture\": \"1.8\",\"focal_length\": \"4.0\",\"iso\": 20 }',
        'Gerson Repreza',
        'https://unsplash.com/@gersonrepreza',
        'https://unsplash.com/photos/Y7umJ1i_qgw',
        '[ \"#E7E3EA\", \"#D3B9B0\", \"#725946\", \"#A3D0DB\", \"#9EA3A6\" ] '
    ),
    (
        143,
        11,
        'Taj Mahal at the sunrise',
        ...
        'AS',
        '48860966717.jpg',
        '{ \"make\": \"SONY\",\"model\": \"ILCE-7RM3\",\"exposure_time\": \"1/25\",\"aperture\": \"3.5\",\"focal_length\": \"47.0\",\"iso\": 1000 }',
        'Julian Yu',
        'https://unsplash.com/@littlej1428',
        'https://unsplash.com/photos/_WuPjE-MPHo',
        '[ \"#8D95A6\", \"#B7C2E0\", \"#CFD8F2\", \"#45514F\", \"#63743D\" ] '
    ),
    (
        144,
        11,
        ...
        'AS',
        '48860308683.jpg',
        '{ \"make\": \"Apple\",\"model\": \"iPhone X\",\"exposure_time\": \"1/1736\",\"aperture\": \"2.4\",\"focal_length\": \"6.0\",\"iso\": 16 }',
        'Ravi N Jh',
        'https://unsplash.com/@ravinathjha',
        'https://unsplash.com/photos/aU9yXmIwfkw',
        '[ \"#8D95A6\", \"#B7C2E0\", \"#27311B\", \"#63743D\", \"#D2D2E3\" ] '
    ),
    (
        145,
        11,
        ...
        NULL,
        'Raghu Nayyar',
        'https://unsplash.com/@raghunayyar',
        'https://unsplash.com/photos/EpAq2EE-shg',
        '[ \"#E3C59E\", \"#2F5802\", \"#083101\", \"#806540\", \"#4A3A20\" ] '
    ),
    (
        146,
        11,
        ...
        NULL,
        'Ravi Shekhar',
        'https://unsplash.com/@rvshekhar10',
        'https://unsplash.com/photos/P0a6TT0CvKg',
        '[ \"#7C6D96\", \"#2B2447\", \"#3C271A\", \"#7E4923\", \"#B57241\" ] '
    ),
    (
        147,
        29,
        'Snowfall in Ljubljana',
        'Triple bridge in January',
        46.05119,
        14.505978,
        3196359,
        'SI',
        'EU',
        '48832945753.jpg',
        '{ \"make\":\"NIKON CORPORATION\", \"model\":\"Nikon D7200\", \"exposure_time\":\"1/100\", \"aperture\":\"1.8\", \"focal_length\":\"35.0\", \"iso\": 1600 }',
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48832945753/',
        '[ \"#13322E\", \"#525939\", \"#5C6965\", \"#7B7A4B\", \"#8D998B\" ] '
    ),
    (
        148,
        29,
        ...
        'Randy Connolly',
        'https://www.flickr.com/photos/randyconnolly',
        'https://www.flickr.com/photos/randyconnolly/48833486122',
...
CREATE TABLE `imagerating` (
    `ImageRatingID` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `languages` (
    ...
    `iso` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
    PRIMARY KEY (`id`)
...
--
-- Table structure for table `photo_deletions`
--

DROP TABLE IF EXISTS `photo_deletions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */
;
/*!50503 SET character_set_client = utf8mb4 */
;
...
--
-- Dumping data for table `photo_deletions`
--

/*!40000 ALTER TABLE `photo_deletions` DISABLE KEYS */
;
/*!40000 ALTER TABLE `photo_deletions` ENABLE KEYS */
;
...
VALUES (
    ...
    (
        ...
        'As part of John and I\'s journey across Canada, we found ourselves finally leaving the prairies and heading to Calgary, one of Canada\'s major cities, which lies less than an hour\'s drive from the mountains.<p>The weather was tremendous. Fall colors had blanketing the city, though there still was plenty of green. Perhaps my favorite photo location was Edworthy Park in Calgary. This park is on the western edge of the city right beside the Bow River. The park is also bordered by hills that contain what are amounts to old-growth forests.<p>Evidently the park used to be part of a ranch with cows and horses. While we didn\'t see any domestic animals, there were a variety of wonderful trails meandering through the hills, from which I snapped these photos.',
        '2011-10-08 00:00:00'
    ),
    (
        3,
        ...
        5,
        'Mountain Climbing',
        'The highlight of our last trip to Canada was a climb up Sulpher Mountain just outside of Banff. I\'d like to say that it was so difficult that we required crampons, pitons, and screamers … but that would be stretching the truth for sure.<p>The ascent up Sulpher Mountain in fact can be made via a gondola. We decided to walk instead, which took us just about 90 minutes, if I remember correctly. There were lots of other people making the same ascent. Most of the climb is a series of eventually tedious switchbacks. Yet the view eventually becomes quite stunning, allowing one to view up and down the Bow River valley.',
        '2011-09-03 00:00:00'
    ),
    (
        4,
...
CREATE TABLE `users` (
    ...
    `Postal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `Phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `Email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `Privacy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    PRIMARY KEY (`UserID`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */
;
...
VALUES (
    ...
    (
        ...
        'Astrid',
        'Gruber',
        'Rotenturmstrasse 4, 1010 Innere Stadt',
        'Vienna',
        NULL,
        'Austria',
        '1010',
...
CREATE TABLE `userslogin` (
    ...
    `Password_sha256` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
VALUES (
        1,
        'luisg@embraer.com.br',
        '$2a$12$F.jpatdVlOnrYWLi/lxPNO90T0auUpFnDP5JTb3aTx7z1QSu5nX42',
        '048d741e931f907110adf460816ff958',
        'b7f054c4c6a92aeb1813ccf0b162cab31cdb9cad0a6cd3820a724f0819af20c',
        1,
        '2012-10-08 00:00:00',
        '2018-11-15 00:00:00'
    ),
    (
        2,
        'leonekohler@surfeu.de',
        '$2a$12$o9lzPmLOFgpODyhYHUOXO.wojqkQph.fBZKO8k83hromrC0bC4TFi',
        '9bce2f838034b8c8d2ba1220daef2e7e',
    ...
    (
        3,
        'ftremblay@gmail.com',
        '$2a$12$QYTq9bIvZ/asycZCoh.GAOhsycshCzvEahXvXRrCczdqnGFdZ0XVS',
    ...
    (
        4,
        'bjorn.hansen@yahoo.no',
        '$2a$12$43FcE3LDDWlev12JkV4qae45LouL6pbXz/GeE4vSNT56OU1tAzdW2',
        'd24e7731e8051cf253ca8e89e0dd0be9',
    ...
    (
        5,
        'frantisekw@jetbrains.com',
        '$2a$12$FbS.fUfQT9Aq9D8REtRx5udl4wKwxKwSuhgEe1Ef0EPcGDZoB8GCS',
        'b3f2be95228f481bc544154fa77b56c6',
    ...
    (
        6,
        'hholy@gmail.com',
        '$2a$12$TnZVOMj5H27JLk/IHtEsD.1cVrSuvToa9dAyM8QbENRXP74MVT5cm',
        '231e1ed0db2b5dc8193ac7c78071aea4',
        '62f5f09daf08a97ef8471d76ebf625bdaab121451bfd062d5a138bf04e30f8a1',
        1,
        '2012-11-01 00:00:00',
        '2018-12-14 00:00:00'
    ),
    (
        7,
        'astrid.gruber@apple.at',
        '$2a$12$VWASiGnTzmFyqnv1j/WkaO5ihBDsQ/swN9ZkrooGkzxweGV/uft8K',
        '7f9301cbee13b0afb7e7c79aa65c9483',
    ...
    (
        8,
        'fharris@google.com',
        '$2a$12$R1vJzRYOg/SIW1yNyWEjCugGbBIC58fmxjjd.0ck1W6iWvrSBKGh6',
    ...
    (
        9,
        'jacksmith@microsoft.com',
        '$2a$12$mWaauD2uy2oWG/9TO7nGvOSMZf44334WBjXJjOIzR9s66ziS3KuSq',
        '1fc0e8b9a5704994608c34a189228f51',
        'fb78347933ba30fd2ac53bd1d98581bbd612721f2ca177e87913c5a7773e6e40',
        1,
        '2012-11-16 00:00:00',
    ...
    (
        10,
        'michelleb@aol.com',
        '$2a$12$Wb8L5KpmiYMDkh5dbPFM1OsyJMRhvZ0ZuidyOiudB9OX7qy6T/.I6',
        '23a56dcf9c599bf803f2b7abf1db4b79',
        'c46a4d121688f1fe18d23d35af64a74325255a4dbea07f6b18640ca055c54b68',
        1,
        '2012-12-07 00:00:00',
        '2019-03-07 00:00:00'
    ),
    (
        11,
        'tgoyer@apple.com',
        '$2y$12$mgw9OzdYyB2zIXYGptdiHef7022jL.VLk.37oAodHyYA2Qd1nll4G',
        'ea9f13c97a277bb3917b63a2a1234b39',
        '746848aba0c93093bbba9dd75f41e687f1651b5888d06c10a21b65d80005e1ee',
        1,
        '2013-01-14 00:00:00',
        '2019-04-19 00:00:00'
    ),
    (
        12,
        'robbrown@shaw.ca',
        '$2y$12$gdd2LeAoUr0hzE43MhCeJuOSOLoEB/o0G.tUYjr65cNUUCTbnM2Xe',
        '23a56dcf9c599bf803f2b7abf1db4b79',
        'c46a4d121688f1fe18d23d35af64a74325255a4dbea07f6b18640ca055c54b68',
        1,
        '2013-02-07 00:00:00',
    ...
    (
        13,
        'edfrancis@yachoo.ca',
        '$2y$12$ZrtstCZGgKBbbC7kSFrQHOacz3blMEXQgTfpwv4GQyKG5pOSOsN/i',
        '1fc0e8b9a5704994608c34a189228f51',
        'fb78347933ba30fd2ac53bd1d98581bbd612721f2ca177e87913c5a7773e6e40',
        1,
        '2012-12-20 00:00:00',
    ...
    (
        15,
        'marthasilk@gmail.com',
        '$2y$12$uOsOiU5EUrsHxDlQuGSh9em/Dd8Sub9FDCPcshfdYdlGthwZUi9FW',
        '231e1ed0db2b5dc8193ac7c78071aea4',
        '62f5f09daf08a97ef8471d76ebf625bdaab121451bfd062d5a138bf04e30f8a1',
        1,
        '2012-11-17 00:00:00',
    ...
    (
        16,
        'aaronmitchell@yahoo.ca',
        '$2y$12$xpmpbRqGQx4Oc0DWl6i27egN/hBRkIEA6sYQo4zbKLXyGJRNY6voO',
        'b3f2be95228f481bc544154fa77b56c6',
        'c7c097bac3f74fb336965b98de2aa84afa6bae00651761be7277bc464869efce',
        1,
        '2013-02-12 00:00:00',
    ...
    (
        ...
        '$2a$12$Wb8L5KpmiYMDkh5dbPFM1OsyJMRhvZ0ZuidyOiudB9OX7qy6T/.I6',
        '048d741e931f907110adf460816ff958',
        '1b7f054c4c6a92aeb1813ccf0b162cab31cdb9cad0a6cd3820a724f0819af20c',
        1,
        '2012-07-29 00:00:00',
        '2018-12-10 00:00:00'
    ),
    (
        20,
        'hannah.schneider@yahoo.de',
        '$2y$12$qzh6jvFIvGSKtSpr4SOBcuPgZ0N/zRfwTq594pV2oz59JQwGBEakW',
        'c3a10800118c3bc6c50b1ac82d31e4a6',
        'b8e62ee19ebbc23976b21e0820723405e27de1d4f2fd24e4e1f456c129cee82c',
        1,
        '2012-08-01 00:00:00',
    ...
    (
        24,
        'phil.hughes@gmail.com',
        '$2y$12$ZhfTqJ3svu5zPT3/rxJko.fsw1Pt1mLyrMlQh5Wv.6AqE9bvWDxbm',
        '1fc0e8b9a5704994608c34a189228f51',
        'fb78347933ba30fd2ac53bd1d98581bbd612721f2ca177e87913c5a7773e6e40',
        1,
        '2012-07-24 00:00:00',
    ...
    (
        26,
        'puja_srivastava@yahoo.in',
        '$2y$12$DnFhcTPWRs7maY.hr4ATVuJJ5fqbJL18JE7CceHQizLAchXEXcAPu',
        'b3f2be95228f481bc544154fa77b56c6',
        'c7c097bac3f74fb336965b98de2aa84afa6bae00651761be7277bc464869efce',
        1,
        '2013-02-01 00:00:00',
    ...
    (
        27,
        'mark.taylor@yahoo.au',
        '$2y$12$l8QIBkyp/7mEYl.983P5l..H9DNsCY.LES4aBAYptS.UTJ5IqbHSK',
        'd24e7731e8051cf253ca8e89e0dd0be9',
        'e7a6803fc7d3db79780e300167aa8d05efebcffe5dba3a760f4f8eafe84a1af6',
        1,
        '2012-09-17 00:00:00',
    ...
    (
        28,
        'ricunningham@hotmail.com',
        '$2y$12$lYIaYSjt3KqiZNSrTENGOushxHk9B1yMLkzK.N25bfF3C3h2lS7He',
        '9bce2f838034b8c8d2ba1220daef2e7e',
        'b3efa8c9c09f76778fdd7f70b340c69a03d48861d2424bb5f4f4cd0d7ce11c06',
        1,
        '2012-08-21 00:00:00',
...
-- Dump completed on 2024-12-05  1:34:03